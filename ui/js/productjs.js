...
function sendProduct(){
	...
	if (product==null || product=='')
		...
		var url="https://sentdecoderservice.cfapps.eu10.hana.ondemand.com/twitter/sentiment";
		...
		try
		{
			...
			prequest.send(JSON.stringify({ "query": bProductQuery + " " + pQuery, "limit": "300", "country":"none", "area":"500"}));
		}
		catch(e)
		{
...
function getProduct()
{
	if(prequest.readyState==4){
		...
		for(i=0;i<results.length;i++){
			value = parseFloat(results[i].sentiment);
			if (value>0)
				totPos++;
			else if (value<0)
				totNeg++;
